package asunit.framework {
	...
	public class TestCase extends Assert implements Test 	{
		...
		protected function cleanUp():void 		{
			...
			try 			{				log.info("------ Starting test: %s()", methodName);
			...
			catch(afe:AssertionFailureError) 			{
				getResult().addFailure(this, afe);
			}
...
//			result.addFailure(this, new AssertionFailureError(message));
//		}
	}
}